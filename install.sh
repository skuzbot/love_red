...
if [ -z "$1" ]; then
  ...
  echo "Usage: bash <(curl -s https://raw.githubusercontent.com/valo/love_red/master/install.sh) <PROJECT_NAME>"
  exit 1
fi

set -e

GITHUB_SRC='https://github.com/valo/love_red.git'
SKELETON_MODULE_NAME="LoveRed"
SKELETON_PROJECT_NAME="love_red"
